...
| **PdtPisotBoundary** | Every non-real root of x³−x−1 has modulus **< 1** and every non-real root of x⁴−x−1 has modulus **> 1** — an elementary Vieta reduction, kernel-checked: ρ is Pisot, Q is not. |
| **PdtClock** | The mechanical (Beatty) word of an abstract irrational slope β: **two-valued**, density → β, **aperiodic**, and **balanced** — with irrationality carried as an explicit hypothesis throughout. |
