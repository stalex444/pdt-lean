...
| PALOMAR-2026-09-01-PENDING | [only-two-morphic-numbers](https://github.com/stalex444/only-two-morphic-numbers) | the Aarts–Fokkink–Kruijtzer classification: the golden ratio and the plastic number are the only morphic numbers |
