...
| *(registered 2026-09-01; ID propagating)* | [golden-family-boundary](https://github.com/stalex444/golden-family-boundary) | the golden family x^n = x + 1: one shared lemma (no root at a primitive cube root of unity), the morphic boundary iff n ≤ 3 unconditionally, the measure/Pisot equivalence, the Siegel-conditional excess, and the degree-4 separation — eleven theorems |
