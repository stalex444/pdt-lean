...
% evaluate (amber); the quantum statements trace back to it.
...
\begin{assumption}[The one identification (not evaluated here)]
  ...
  complex-structure hypothesis is what the kinematics below use; whether the physical world's
...
\begin{theorem}[The Born rule, derived]
  ...
  \lean{PDT.QM_from_Q}
  \leanok
  \uses{ass:posit, lem:born_form, lem:hermitian, lem:unitary}
  The capstone, assembling the kinematics. Given the complex structure, for a normalized two-outcome
  state the Born probabilities equal the conjugate-twisted trace form $|z|^2$, are
